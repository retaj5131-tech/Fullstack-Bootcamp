...
function App() {
  ...
  return (
    ...
    >
      ...
      <img src={lanternRight} alt="Right Lanterns" className="absolute top-10 right-5 w-32 md:w-100 opacity-80 z-2" />
      <img src={lanternLeft} alt="Left Lanterns" className="absolute top-10 left-5 w-32 md:w-100 opacity-80 z-2" />
